...
install_packages = nbf.new_code_cell("!pip install numpy sentence-transformers matplotlib scikit-learn nltk langdetect")

# Import Libraries and Download NLTK Data
import_libraries = nbf.new_code_cell("""
import numpy as np
...
helper_functions = nbf.new_code_cell("""
...
# Continue creating the notebook after encountering an issue with the length

# Main Segmentation and Visualization Functions - Part 1
main_functions_part1 = nbf.new_code_cell("""
...
# Main Segmentation and Visualization Functions - Part 2
main_functions_part2 = nbf.new_code_cell("""
...
visualization_functions = nbf.new_code_cell("""
...
# Segment and Visualize Document
segment_and_visualize = nbf.new_code_cell("""
...
# Final code cell for segmentation and visualization - Completion and Execution

segment_and_visualize_continued = nbf.new_code_cell("""
    return chunks, smoothed_scores, boundaries
...
nb['cells'].extend([
    ...
    import_libraries,
    helper_functions,
    main_functions_part1,
    main_functions_part2,
    visualization_functions,
    segment_and_visualize,
    segment_and_visualize_continued
])

with open('Document_Segmentation.ipynb', 'w') as f:
